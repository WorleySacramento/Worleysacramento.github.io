        ...
        <div className={styles.container}>
            <div>
                ...
                <p className={styles.paragrafo}>
                    Olá, meu nome é Worley e tenho 39 anos. Me formei em Análise e Desenvolvimento de Sistemas em junho de 2023. Sou pai de três filhos. Estou animado para compartilhar meu portfólio com você e discutir como posso ajudá-lo com seus projetos de desenvolvimento de software.
                ...
                <div className={styles.lists}>
                    ...
                    <div className={styles.list1}>
                        ...
                        <ul>
                            ...
                            <li>Criar aplicativos móveis usando o framework Expo.</li>
